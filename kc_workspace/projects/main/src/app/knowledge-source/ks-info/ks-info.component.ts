import {Component, Input, OnChanges, EventEmitter, OnInit, Output, SimpleChanges, ViewChild} from '@angular/core';
import {KnowledgeSourceReference, KnowledgeSource} from "../../../../../shared/src/models/knowledge.source.model";
