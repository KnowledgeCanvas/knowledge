...
export class KnowledgeCanvas {
    ...
    private ksList: KnowledgeSource[] = [];
    private cyLayout: LayoutOptions = {
        name: "dagre",
    ...
    private cyOptions: CytoscapeOptions = {
        container: this.cyContainer,
        layout: this.cyLayout,
        style: [
            {
                selector: 'edge',
                style: {'line-color': 'cyan', 'width': 5}
            },
            {
                selector: 'node',
                style:
    ...
    constructor(options?: CytoscapeOptions) {
        ...
        // Wait for data from Electron process, then populate the graph
        // TODO: ...
